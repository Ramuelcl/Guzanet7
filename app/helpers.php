...
//
if (!function_exists('fncSweetAlert')) {
    function fncSweetAlert($titulo = 'titulo', $mensaje = 'mensaje', $accion = '', $tipo_alerta = 'info')
    {
        // Incluye la biblioteca SweetAlert2 (asegúrate de tenerla instalada)
        // Ejemplo: <script src="ruta/a/sweetalert2.min.js"></script>

        // Crea una alerta personalizada utilizando SweetAlert2
        echo <<<HTML
        <script>
            Swal.fire({
                title: '$titulo',
                ...
                if (resultado.isConfirmed) {
                    // Acción cuando se hace clic en el botón "OK"
